...
export const npcs=[
 npc('Cira Vale','inn',500,350,["Two gold for a room, five silver for supper. Boasting is free; broken chairs aren't.","The Dealer? I served some of his first opponents, before he ever owned House Veyr. He was strange, but people liked him. He'd match any wager and somehow never lose.","He used to talk about one card more than the others — his favorite. Said anyone who knew it was welcome at his table. Never told me what it was.","If you're asking around about him, keep your voice down. The Jesters have started treating him like some kind of god. He never recruited them and doesn't command them."],{shop:[
   ...
   {name:'Hot supper',description:'A hot supper served at the Gilded Lamb.',price_gp:1,quantity:null},
   {name:'Breakfast plate',description:'Eggs, bread, fried potatoes, and whatever fruit is fresh that morning.',price_gp:1,quantity:null},
   {name:'Mug of ale',description:'A mug of the Lamb’s ordinary house ale.',price_gp:1,quantity:null},
   {name:'Trail ration',description:'One day of bread, dried meat, nuts, and hard cheese packed for the road.',price_gp:1,quantity:null},
   ...
   {name:'Hot bath',description:'Hot water, soap, and a private washroom for one person.',price_gp:1,quantity:null},
 ]}),
 ...
 npc('Ysabet Morrow','arcana',600,400,["If you're buying, take your time. If you're here for stories about the Dealer, the tavern has better ones than I do.","I know the cards are magical. That's about as far as I'll pretend to understand them. There is one odd scrap in the back case that came through with a challenger's effects. You're welcome to look at it."],{asset:'ysabet',shop:[
   ...
   {name:'Boots of Elvenkind',description:'Your footsteps make no sound while worn, and you have advantage on Dexterity (Stealth) checks that rely on moving silently.',price_gp:300,quantity:1},
   {name:'Mirror of Borrowed Faces',description:'After studying a creature’s reflection for 1 minute, you can assume that creature’s appearance and voice for 1 hour, once per day.',price_gp:1200,quantity:1},
   {name:'Cloak of the Falling Star',description:'When attacked, use your reaction to teleport up to 30 feet to a space you can see. Limited charges each day; the cloak leaves a streak of sparks.',price_gp:2500,quantity:1},
