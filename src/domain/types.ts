...
export type Placement = { kind: "CHARACTER" | "MONSTER" | "DISCOVERABLE"; referenceId: string; name: string; imageUrl: string | null; } | { kind: "CHARACTERS"; referenceIds: string[]; name: string; imageUrl: null; } | { kind: "SCENE_LINK"; destinationSceneId: string; name: string; imageUrl: null; };
